...
Route::middleware(['onec.api', 'onec.log'])->prefix('1c')->group(function () {
    ...
    Route::post('/stocks/snapshot', [OneCController::class, 'stocksSnapshot']);
    ...
    Route::post('/import-file', [OneCController::class, 'importFile']);
    ...
    Route::post('/queue', [OneCController::class, 'syncQueue']);
});
